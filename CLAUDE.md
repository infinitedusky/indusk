...
|------|-------|-----------|
| agent-roles | impl (completed, awaiting /falsify + /retrospective) | Run `/falsify agent-roles`, then `/retrospective agent-roles` |
