# @infinitedusky/telemetry-binaries-darwin-x64

Native binaries for `darwin-x64`, bundled for [`@infinitedusky/indusk-mcp`](https://www.npmjs.com/package/@infinitedusky/indusk-mcp)'s `local-telemetry` extension.
...
This package is installed automatically via npm's platform-matching `optionalDependencies` when you `npm install @infinitedusky/indusk-mcp` on a `darwin-x64` machine. Do not depend on it directly.
