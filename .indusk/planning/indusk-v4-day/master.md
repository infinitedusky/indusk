...
| 1 | **Trust the substrate** | 10 | **impl complete 2026-09-10** (18 rows green on `plan/workbench-trust-fixes`); falsify → cleanup → retrospective → merge | Zero silent wrong answers from run / cleanup / eval in every workbench shape (its brief) | [workbench-trust-fixes](../workbench-trust-fixes/brief.md), Phase A |
