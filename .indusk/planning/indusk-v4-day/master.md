...
| 4b | **Monitor — promise violation detection and root cause, from telemetry** | 9 | brief rewritten 2026-09-17 (was `midnight`; exists nowhere — looper's nine incidents are all smoke or desk) | A production alert names the promise that broke; the incident records the root cause; the owning plan reopens | [day-monitor](../day-monitor/brief.md) |
...
- **4b needs 4a**, and Dash0 connected: the telemetry half watches promises
