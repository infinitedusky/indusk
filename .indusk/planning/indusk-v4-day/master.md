...
| 4a | **Promises — the contract's primitive: registry, kinds, states, links, the check** | 9 | brief accepted, test plan accepted, ADR proposed 2026-09-18 (this repo has dozens of unregistered structure promises and no registry) | The check refuses every way the registry can lie, by name, and passes a clean registry with a summary; this repo holds three, one per kind, with the check in its suite; the Promises page lists them with every enforced chip hollow | [day-promises](../day-promises/brief.md) |
...
|------|-----------|-------|
| `day-promises` | 4a — the promise as a primitive: registry, kinds, lifetimes, states, links, `indusk promises check`, self-hosting, the Promises page | brief accepted, test plan accepted, ADR proposed 2026-09-18 |
