...
| 3.8 | [code-reviewer-agent](code-reviewer-agent/impl.md) | **PROMOTED → see Immediate I.3** (impl draft; sibling of eval agent: post-commit reviewer, anchored to CLAUDE.md/AGENTS.md conventions, MVP scope = cleanliness/DRY/large-function rules; tests-red-first trajectory; opt-in via `review.enabled: false` default) | — | (additional commit-time signal source; future Dawn-petal candidate) |
...
1. **Immediate** (this week):
   ...
   - `/work code-reviewer-agent` (I.3) — independent, parallel-safe
