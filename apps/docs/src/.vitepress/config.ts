			...
			"/decisions/": [
				{
					...
					items: [
						...
						{ text: "Writing Skill", link: "/decisions/writing-skill" },
					],
				},
			],
			"/lessons/": [
				{
					...
					items: [
						...
						{ text: "Lessons from planner-hotfix-mode", link: "/lessons/planner-hotfix-mode" },
						{ text: "Rationale Baseline Frontmatter — Lessons", link: "/lessons/rationale-baseline-frontmatter" },
						{ text: "Lessons from stale-indusk-docs-path", link: "/lessons/stale-indusk-docs-path" },
