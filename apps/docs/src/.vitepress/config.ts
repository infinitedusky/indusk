...
const config = defineConfig({
	...
	themeConfig: {
		...
		nav: [
			...
			{ text: "Versioned Workbench", link: "/lessons/versioned-workbench" },
			...
			"/guide/": [
				{
					...
					items: [
						...
						{ text: "Rail Check (post-update)", link: "/guide/rail-check" },
			...
			"/decisions/": [
				{
					...
					items: [
						...
						{ text: "Cleanup Ritual", link: "/decisions/cleanup-ritual" },
