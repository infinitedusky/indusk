...
/**
 * "holding N" — how many promises a plan owns that are not retired. Closed is
 * the resting state; a plan closes holding its promises, and only one holding
 * none is finished. Renders nothing for none, so the fifty archived plans
 * that never stated one stay quiet.
 */
