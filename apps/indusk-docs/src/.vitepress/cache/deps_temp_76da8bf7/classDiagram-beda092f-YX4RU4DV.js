...
// ../../node_modules/.pnpm/mermaid@10.9.5/node_modules/mermaid/dist/classDiagram-beda092f.js
var import_dayjs = __toESM(require_dayjs_min(), 1);
var import_sanitize_url = __toESM(require_dist(), 1);
var edgeCount = 0;
var drawEdge = (elem, path, relation, conf, diagObj) => {
...
var drawClass = (elem, classDef, conf, diagObj) => {
	...
	let isFirst = true;
	classDef.annotations.forEach((member) => {
	...
	title.node().childNodes.forEach((x) => {
...
var getClassTitleString = (classDef) => {
...
var drawNote = (elem, note, conf, diagObj) => {
	...
	const rectWidth = rect.node().getBBox().width;
	text.node().childNodes.forEach((x) => {
		x.setAttribute("x", (rectWidth - x.getBBox().width) / 2);
	});
...
var addTspan = (textEl, member, isFirst, conf) => {
...
var idCache = {};
var padding = 20;
var getGraphId = (label) => {
	const foundEntry = Object.entries(idCache).find((entry) => entry[1].label === label);
	if (foundEntry) {
		return foundEntry[0];
	}
};
var insertMarkers = (elem) => {
	elem
		.append("defs")
		.append("marker")
...
export { diagram };
//# sourceMappingURL=classDiagram-beda092f-YX4RU4DV.js.map
