...
var parser = (() => {
	...
	var parser2 = {
		...
		table: [
			{ 3: 1, 4: 2, 5: $V0, 20: $V1, 21: $V2, 22: $V3 },
			{ 1: [3] },
			{ 3: 7, 4: 2, 5: $V0, 20: $V1, 21: $V2, 22: $V3 },
			o($V4, $V5, { 6: 8, 7: [1, 9] }),
			o($V6, [2, 14]),
			o($V6, [2, 15]),
			o($V6, [2, 16]),
	...
	var lexer = /* @__PURE__ */ (() => {
		var lexer2 = {
			...
			conditions: {
				...
				title: { rules: [6], inclusive: false },
				string: { rules: [15, 16], inclusive: false },
				INITIAL: { rules: [0, 1, 2, 3, 4, 5, 7, 9, 11, 14, 17, 18, 19, 20], inclusive: true },
			},
		};
		return lexer2;
	})();
...
var createPieArcs = (sections2) => {
	const pieData = Object.entries(sections2)
		.map((element) => {
			return {
				label: element[0],
				value: element[1],
	...
	const pie$1 = pie_default().value((d3Section) => d3Section.value);
...
export { diagram };
//# sourceMappingURL=pieDiagram-a8764435-EQU4JO3G.js.map
