...
var addTask = (period, length, event) => {
	const rawTask = {
		id: currentTaskId++,
...
var drawSection = (elem, section, conf) => {
...
var drawBackgroundRect = (elem, bounds) => {
...
var drawNode = (elem, node, fullSection, conf) => {
...
var getVirtualNodeHeight = (elem, node, conf) => {
...
var defaultBkg = (elem, node, section) => {
	const rd = 5;
	elem
		.append("path")
...
var drawTasks = (
	...
	for (const task of tasks2) {
		...
		if (task.events) {
			...
			masterY += 100;
			lineLength =
				lineLength + drawEvents(diagram2, task.events, sectionColor, masterX, masterY, conf);
			masterY -= 100;
			lineWrapper
				.append("line")
...
var drawEvents = (diagram2, events, sectionColor, masterX, masterY, conf) => {
...
export { diagram };
//# sourceMappingURL=timeline-definition-faaaa080-VHPWPOGL.js.map
