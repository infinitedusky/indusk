...
// ../../node_modules/.pnpm/katex@0.16.40/node_modules/katex/dist/katex.mjs
...
var makeOrd = function makeOrd2(group, options, type) {
	...
	if (wideFontName.length > 0) {
		...
		} else if (Object.hasOwn(ligatures, text2) && fontName.slice(0, 10) === "Typewriter") {
			var parts = [];
...
function checkSymbolNodeType(node) {
	if (node && (node.type === "atom" || Object.hasOwn(NON_ATOMS, node.type))) {
		return node;
	}
	return null;
}
...
var Namespace = class {
	 ...
	 */
	has(name) {
		return Object.hasOwn(this.current, name) || Object.hasOwn(this.builtins, name);
	}
	/**
...
defineMacro("\\expandafter", (context) => {
	var t = context.popToken();
...
defineMacro("\\@firstoftwo", (context) => {
...
defineMacro("\\@secondoftwo", (context) => {
	var args = context.consumeArgs(2);
	return {
		tokens: args[1],
		numArgs: 0,
...
defineMacro("\\@ifnextchar", (context) => {
...
defineMacro("\\TextOrMath", (context) => {
	var args = context.consumeArgs(2);
...
var MacroExpander = class {
	...
	isExpandable(name) {
		...
		return macro != null
			...
			: Object.hasOwn(functions, name) && !functions[name].primitive;
	}
};
...
var Parser = class _Parser {
	...
	parseGroup(name, breakOnTokenText) {
		...
		if (text2 === "{" || text2 === "\\begingroup") {
			...
			if (result == null && text2[0] === "\\" && !Object.hasOwn(implicitCommands, text2)) {
	...
	parseSymbol() {
		...
		if (Object.hasOwn(unicodeSymbols, text2[0]) && !symbols[this.mode][text2[0]]) {
...
//# sourceMappingURL=katex-Z6BWQMDY.js.map
