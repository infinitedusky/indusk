...
import { db, parser$1, styles } from "./chunk-TMNHRKAI.js";

// ../../node_modules/.pnpm/mermaid@10.9.5/node_modules/mermaid/dist/stateDiagram-1ecb1508.js
...
var drawDescrState = (g, stateDef) => {
	const addTspan = (textEl, txt, isFirst2) => {
		const tSpan = textEl
			.append("tspan")
			.attr("x", 2 * getConfig().state.padding)
			.text(txt);
	...
	let isFirst = true;
	let isSecond = true;
	stateDef.descriptions.forEach((descr) => {
		if (!isFirst) {
...
var edgeCount = 0;
var drawEdge = (elem, path, relation) => {
...
export { diagram };
//# sourceMappingURL=stateDiagram-1ecb1508-UUAJ5U4F.js.map
