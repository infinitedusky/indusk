...
| D5 | Memory/Knowledge graph at full Indusk depth | DEFER | Graphiti integration ships in v1; CGC defers to v2 (already demoted in Indusk per 1.28.7) | Some structural code-graph queries | Engineers explicitly want code-graph queries. (Indusk experience suggests they don't.) |
| | | | | | |
